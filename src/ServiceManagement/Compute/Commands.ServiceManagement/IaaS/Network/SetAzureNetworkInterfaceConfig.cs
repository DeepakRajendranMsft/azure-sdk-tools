...
namespace Microsoft.WindowsAzure.Commands.ServiceManagement.IaaS.Network
{
    ...
    public class SetAzureNetworkInterfaceConfig : VirtualMachineConfigurationCmdletBase
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                foreach (var interfaces in networkConfiguration.NetworkInterfaces.Where(interfaces => string.Equals(interfaces.Name, this.Name, StringComparison.OrdinalIgnoreCase)))
                {
